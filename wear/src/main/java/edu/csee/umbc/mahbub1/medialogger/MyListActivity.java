...
import edu.csee.umbc.mahbub1.medialogger.pages.AudioFileSyncActivity;
import edu.csee.umbc.mahbub1.medialogger.pages.DataExchangeActivity;
import edu.csee.umbc.mahbub1.medialogger.pages.FileTransferActivity;
import edu.csee.umbc.mahbub1.medialogger.pages.RecordingActivity;
import edu.csee.umbc.mahbub1.medialogger.pages.StockActivity;
import edu.csee.umbc.mahbub1.medialogger.pages.StreamingVoiceActivity;
...
public class MyListActivity extends AbstractWearableListViewActivity {
    ...
    public void onItemClicked(int position, String value) {
        ...
        switch (position) {
            ...
            case 4:
                ...
                break;
            case 5:
                showActivity(RecordingActivity.class);
                break;
            case 6:
                showActivity(AudioFileSyncActivity.class);
                break;
            case 7:
                launchMobileApp();
                break;
    ...
    public WearableListConfig getConfiguration() {
        ...
        int[] icons = new int[]{
                ...
                R.drawable.ic_mic_24dp,
                R.drawable.ic_sync_white_120dp,
