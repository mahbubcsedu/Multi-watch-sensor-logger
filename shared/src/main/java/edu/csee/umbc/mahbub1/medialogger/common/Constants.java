...
public class Constants {
    ...
    public static final int TARGET_VOICE_FILE=7;
    public static final int TARGET_VOICE_PLAY=8;
    ...
    public static final String DATA_PATH_WEAR = "/data/wear";
    public static final String KEY_PAGE = "key-page";
    public static final String MEASUREMENT_PATH_START="/start";
    ...
    public static final String KEY_DATA = "recording_data";
