...
//this.getFilesDir()
    FileObserver observer =
            //new FileObserver(android.os.Environment.getExternalStorageDirectory().toString()
             //       + "/SoundRecorder") {
                new FileObserver(Environment.getExternalStoragePublicDirectory(
                        Environment.DIRECTORY_MUSIC)+"/cliprecorder"){
                ...
                public void onEvent(int event, String file) {
                    if(event == FileObserver.DELETE){
                        ...
                        //        + "/SoundRecorder" + file + "]";
                        String filePath = Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_MUSIC) + "/cliprecorder" + file + "]";
