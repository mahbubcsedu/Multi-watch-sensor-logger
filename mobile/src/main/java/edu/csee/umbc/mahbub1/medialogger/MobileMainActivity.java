...
import edu.csee.umbc.mahbub1.medialogger.pages.AudioFileTransFragment;
import edu.csee.umbc.mahbub1.medialogger.pages.FileTransferFragment;
import edu.csee.umbc.mahbub1.medialogger.pages.IntroFragment;
import edu.csee.umbc.mahbub1.medialogger.pages.VoiceFragment;
import edu.csee.umbc.mahbub1.medialogger.playback.FileViewerFragment;
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        switch (id) {
            ...
            case R.id.nav_open_voice_stream:
                ...
                break;
            case R.id.nav_open_voice_file:
                navigateTo(Constants.TARGET_VOICE_FILE);
                break;
            case R.id.nav_open_voice_play:
                navigateTo(Constants.TARGET_VOICE_PLAY);
                break;
        ...
        switch (target) {
           ...
           /* case Constants.TARGET_STOCK:
            ...
            case Constants.TARGET_VOICE_STREAM:
                ...
                break;
            case Constants.TARGET_VOICE_FILE:
                fragment = new AudioFileTransFragment();
                break;
            case Constants.TARGET_VOICE_PLAY:
        ...
        switch (target) {
           ...
           /* case Constants.TARGET_STOCK:
            ...
            case Constants.TARGET_VOICE_STREAM:
                ...
                break;
            case Constants.TARGET_VOICE_FILE:
                activityName = ".pages.SyncActivity";
                break;
            case Constants.TARGET_VOICE_PLAY:
                activityName = ".pages.AudioFileTransFragment";
                break;
        }
        if (!wearManager
